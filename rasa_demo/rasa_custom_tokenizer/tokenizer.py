...
class MicroTokenizer(Tokenizer):
    ...
    def get_default_config() -> Dict[Text, Any]:
        """Return default config (see parent class for full docstring)."""
        return {
    ...
    def create(
        ...
        """Create a new component (see parent class for full docstring)."""
    ...
    def _load_custom_dictionary(path: Text) -> None:
        ...
        be found in the documentation of MicroTokenizer.
        https://github.com/howl-anderson/MicroTokenizer?tab=readme-ov-file
        """
        import MicroTokenizer

        Micro_userdicts = glob.glob(f"{path}/*")
        for Micro_userdict in Micro_userdicts:
            logger.info(f"Loading MicroTokenizer User Dictionary at {Micro_userdict}")
            MicroTokenizer.load_userdict(Micro_userdict)
